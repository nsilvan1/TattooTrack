        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Card>
            ...
            <CardContent className="p-4 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-lg bg-white/5 border border-white/10 gap-3">
                ...
                {calendarStatus === 'loading' ? (
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <Button
                      ...
                      className="flex-1 sm:flex-none"
                    >
                      <span className="hidden sm:inline">{isDisconnecting ? 'Desconectando...' : 'Desconectar'}</span>
                      <span className="sm:hidden">{isDisconnecting ? '...' : 'Descon.'}</span>
                    </Button>
                  </div>
                ) : (
                  <Button
